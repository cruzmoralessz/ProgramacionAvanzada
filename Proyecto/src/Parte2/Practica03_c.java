...
public class Practica03_c extends JFrame implements ActionListener {
    ...
    public Practica03_c() {
        super("Administración de Productos - Con Archivos CSV");
    ...
    private void cargarDatosDeArchivo() {
        Archivotxt archivo = new Archivotxt("insumos.txt");
        ...
        for (int i = 0; i < datos.size(); i += 3) {
            if (i + 2 < datos.size()) {
                ...
                this.listainsumo.agregarInsumo(nodo);
            }
        }
