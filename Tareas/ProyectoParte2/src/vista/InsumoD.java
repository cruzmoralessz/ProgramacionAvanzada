...
public class InsumoD extends JDialog {
    private final JTextField campoId;
    private final JTextField campoNombre;
    private final JComboBox<CategoriaItem> comboCategorias;
    private boolean accepted;

    public InsumoD(Window owner, String title, String id, String nombre, String selectedCategoriaId, List<Categoria> categorias, boolean editableId) {
